...
from constants import INDENT_LEFT, INDENT_TOP, \
    ...
    TEXT_SCORE_COLOR, TEXT_SCORE_SIGN_COLOR, TEXT_NEXT_SIZE, TEXT_NEXT_COLOR


def draw_text(screen, score):
    font = pg.font.Font(None, 30)
    
    text1 = font.render("Счёт:", True, TEXT_SCORE_SIGN_COLOR)
    text1_x = INDENT_LEFT + WIDTH_OF_PLAYGROUND * CELL_SIZE + INDENT_LEFT + INDENT_LEFT
    text1_y = INDENT_TOP
    screen.blit(text1, (text1_x, text1_y))

    font2 = pg.font.Font(None, 50)

    text2 = font2.render(str(score), True, TEXT_SCORE_COLOR)
    text2_x = text1_x
    ...
    text3_x = text1_x
    text3_y = text2_y + TEXT_SCORE_SIZE + INDENT_TOP + INDENT_TOP + INDENT_TOP
    screen.blit(text3, (text3_x, text3_y))
    
    text4 = font3.render("фигура:", True, TEXT_NEXT_COLOR)
    text4_x = text1_x
    text4_y = text3_y + TEXT_NEXT_SIZE + INDENT_TOP
